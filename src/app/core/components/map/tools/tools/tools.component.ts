...
import { Annotation, TokenAnnotation, CircleAnnotation, RectangleAnnotation, PolygonAnnotation, MarkerTypeAnnotation, PolylineAnnotation, ImageAnnotation, TextAnnotation } from 'src/app/core/model';
...
export class ToolsComponent  {
  ...
  isTextSelected() {
    return TextAnnotation.is(this.selected)
  }

...
import { faStar as SOLID_STAR, faFunction, faDiceD4, faDiceD6, faDiceD8, faDiceD10, faDiceD12, faCoin,faMinus, faTimesSquare, faQrcode, faWalking, faTasksAlt, faUniversalAccess,
...
export class Icons {
  ...
  solidPro(l : FaIconLibrary) {
    l.addIcons(
      faFunction, faTimesSquare,faQrcode,faWalking, faTasksAlt, faUniversalAccess,
